"""
This script will extract the short interest notifications of the AMF.
"""
...
for f in os.listdir('/home/daniel/Desktop/Scripts/_ShortNotifications/'):
    file_name = 'XPAR_{}'.format(TimeStamp())
...
for sht in sheets:
    ...
    try:
        ...
        for i in range(20):
            try:
                if re.search('POSITION', df.iloc[i,0].upper()):
                    j = i + 2
                    break
            except:
                pass
        ...
        for clm in df.columns:
            ...
            elif re.search('RATIO', clm.upper()) or re.search('CAPITAL', clm.upper()):
